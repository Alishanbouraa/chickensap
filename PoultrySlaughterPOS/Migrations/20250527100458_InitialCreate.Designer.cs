...
namespace PoultrySlaughterPOS.Migrations
{
    ...
    [Migration("20250527100458_InitialCreate")]
            ...
            modelBuilder.Entity("PoultrySlaughterPOS.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 5, 27, 13, 4, 57, 615, DateTimeKind.Local).AddTicks(2379),
                            CustomerName = "سوق الجملة المركزي",
                            IsActive = true,
                            PhoneNumber = "07901234567",
                            TotalDebt = 0m,
                            UpdatedDate = new DateTime(2025, 5, 27, 13, 4, 57, 615, DateTimeKind.Local).AddTicks(2381)
                        },
                        new
                        {
                            CustomerId = 2,
                            Address = "بغداد - الجادرية",
                            CreatedDate = new DateTime(2025, 5, 27, 13, 4, 57, 615, DateTimeKind.Local).AddTicks(2389),
                            CustomerName = "مطعم الأصالة",
                            IsActive = true,
                            PhoneNumber = "07801234567",
                            TotalDebt = 0m,
                            UpdatedDate = new DateTime(2025, 5, 27, 13, 4, 57, 615, DateTimeKind.Local).AddTicks(2390)
                        },
                        new
                        {
                            CustomerId = 3,
                            Address = "بغداد - الأعظمية",
                            CreatedDate = new DateTime(2025, 5, 27, 13, 4, 57, 615, DateTimeKind.Local).AddTicks(2397),
                            CustomerName = "متجر الطازج للدواجن",
                            IsActive = true,
                            PhoneNumber = "07901234568",
                            TotalDebt = 0m,
                            UpdatedDate = new DateTime(2025, 5, 27, 13, 4, 57, 615, DateTimeKind.Local).AddTicks(2399)
                        });
                });
            ...
            modelBuilder.Entity("PoultrySlaughterPOS.Models.Truck", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TruckId = 1,
                            CreatedDate = new DateTime(2025, 5, 27, 13, 4, 57, 615, DateTimeKind.Local).AddTicks(2192),
                            DriverName = "أحمد محمد",
                            IsActive = true,
                            TruckNumber = "TR-001",
                            UpdatedDate = new DateTime(2025, 5, 27, 13, 4, 57, 615, DateTimeKind.Local).AddTicks(2194)
                        },
                        new
                        {
                            TruckId = 2,
                            CreatedDate = new DateTime(2025, 5, 27, 13, 4, 57, 615, DateTimeKind.Local).AddTicks(2202),
                            DriverName = "محمد علي",
                            IsActive = true,
                            TruckNumber = "TR-002",
                            UpdatedDate = new DateTime(2025, 5, 27, 13, 4, 57, 615, DateTimeKind.Local).AddTicks(2204)
                        },
                        new
                        {
                            TruckId = 3,
                            CreatedDate = new DateTime(2025, 5, 27, 13, 4, 57, 615, DateTimeKind.Local).AddTicks(2211),
                            DriverName = "علي حسن",
                            IsActive = true,
                            TruckNumber = "TR-003",
                            UpdatedDate = new DateTime(2025, 5, 27, 13, 4, 57, 615, DateTimeKind.Local).AddTicks(2213)
                        });
                });
